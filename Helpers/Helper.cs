...
namespace GivlsWeapons.Helpers
{
	public static partial class Helper
	{
		...
		public static Vector2 RotateAroundPoint(Vector2 vector, Vector2 center, float angle)
		{
			...
			float cosTheta = MathF.Cos(angle);
			float sinTheta = MathF.Sin(angle);
			float x = translatedVector.X * cosTheta - translatedVector.Y * sinTheta;
			float y = translatedVector.X * sinTheta + translatedVector.Y * cosTheta;
