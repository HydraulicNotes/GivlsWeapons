...
{
    public class TeleportingAxes : ModItem
    {
    ...
    public class TeleportingAxePlayer : ModPlayer
    {
    ...
    public class TeleportingAxeProjectile : ModProjectile
    {
        ...
        private ref float AirTimer => ref Projectile.ai[1]; //Tracks how long this projectile has been in the air and whether it's currently stuck
        public override void SetDefaults()
        {
        ...
        public override void AI()
        {
            ...
            { //Runs if there is no collision
                ...
                {
                    AirTimer += 1f;
                    if (AirTimer >= 30f) //Gravity sets in after 30 updates (1/4 second), or if it falls after sticking in a block
                    {
            ...
            { //Runs if there is a collision. OnTileCollide is not used, as default collision would push the projectile out of slopes
                ...
                if (AirTimer > -1) //to prevent the sound from looping
                {
    ...
    public class TeleportingAxeSwingProjectile : ModProjectile
    {
        ...
        public override string Texture => "GivlsWeapons/Content/Items/Weapons/TeleportingAxeProjectile"; // Use texture of item as projectile texture
